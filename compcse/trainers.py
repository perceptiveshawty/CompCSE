...
class CLTrainer(Trainer):
    ...
    def evaluate(
        ...
        stsb_uniformity = results['STSBenchmark']['dev']['uniform_loss']

        metrics = {"eval_stsb_spearman": stsb_spearman, "eval_sickr_spearman": sickr_spearman, "eval_avg_sts": (stsb_spearman + sickr_spearman) / 2, "eval_stsb_align": float(stsb_alignment), "eval_stsb_uniform": float(stsb_uniformity)} 
        if eval_senteval_transfer or self.args.eval_transfer:
            avg_transfer = 0
